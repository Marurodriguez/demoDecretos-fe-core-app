(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(require('@angular/core'),exports, require('@angular/core'), require('rxjs'), require('@angular/common'), require('rxjs/operators'), require('@angular/fire'), require('@angular/router'), require('@angular/platform-browser')) :
    typeof define === 'function' && define.amd ? define('@angular/fire/analytics', ['@angular/core','exports', '@angular/core', 'rxjs', '@angular/common', 'rxjs/operators', '@angular/fire', '@angular/router', '@angular/platform-browser'], factory) :
    (global = global || self, factory(global.ng.core,(global.angular = global.angular || {}, global.angular.fire = global.angular.fire || {}, global.angular.fire.analytics = {}), global.ng.core, global.rxjs, global.ng.common, global.rxjs.operators, global.angular.fire, global.ng.router, global.ng.platformBrowser));
}(this, (function (ɵngcc0,exports, i0, rxjs, common, operators, i1, i2, i3) { 'use strict';
...
AngularFireAnalytics.ɵfac = function AngularFireAnalytics_Factory(t) { return new (t || AngularFireAnalytics)(ɵngcc0.ɵɵinject(i1.FIREBASE_OPTIONS), ɵngcc0.ɵɵinject(i1.FIREBASE_APP_NAME, 8), ɵngcc0.ɵɵinject(COLLECTION_ENABLED, 8), ɵngcc0.ɵɵinject(APP_VERSION, 8), ɵngcc0.ɵɵinject(APP_NAME, 8), ɵngcc0.ɵɵinject(DEBUG_MODE, 8), ɵngcc0.ɵɵinject(CONFIG, 8), ɵngcc0.ɵɵinject(i0.PLATFORM_ID), ɵngcc0.ɵɵinject(i0.NgZone)); };
...
ScreenTrackingService.ɵfac = function ScreenTrackingService_Factory(t) { return new (t || ScreenTrackingService)(ɵngcc0.ɵɵinject(AngularFireAnalytics), ɵngcc0.ɵɵinject(i2.Router, 8), ɵngcc0.ɵɵinject(i3.Title, 8), ɵngcc0.ɵɵinject(i0.ComponentFactoryResolver), ɵngcc0.ɵɵinject(i0.PLATFORM_ID), ɵngcc0.ɵɵinject(DEBUG_MODE, 8), ɵngcc0.ɵɵinject(i0.NgZone), ɵngcc0.ɵɵinject(i0.Injector)); };
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(ScreenTrackingService, [{
        type: i0.Injectable,
        args: [{
                providedIn: 'any'
            }]
    }], function () { return [{ type: AngularFireAnalytics }, { type: i2.Router, decorators: [{
                type: i0.Optional
                ...
                type: i0.Inject,
                args: [DEBUG_MODE]
            }] }, { type: i0.NgZone }, { type: i0.Injector }]; }, null); })();
...
UserTrackingService.ɵfac = function UserTrackingService_Factory(t) { return new (t || UserTrackingService)(ɵngcc0.ɵɵinject(AngularFireAnalytics), ɵngcc0.ɵɵinject(i0.NgZone), ɵngcc0.ɵɵinject(i0.PLATFORM_ID)); };
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(UserTrackingService, [{
        type: i0.Injectable,
        args: [{
                providedIn: 'any'
            }]
    }], function () { return [{ type: AngularFireAnalytics }, { type: i0.NgZone }, { type: Object, decorators: [{
                type: i0.Inject,
                args: [i0.PLATFORM_ID]
            }] }]; }, null); })();
