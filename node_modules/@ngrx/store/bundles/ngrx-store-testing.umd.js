(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(require('@angular/core'),exports, require('@angular/core'), require('rxjs'), require('@ngrx/store'), require('@angular/core/testing')) :
    typeof define === 'function' && define.amd ? define('@ngrx/store/testing', ['@angular/core','exports', '@angular/core', 'rxjs', '@ngrx/store', '@angular/core/testing'], factory) :
    (global = global || self, factory(global.ng.core,(global.ngrx = global.ngrx || {}, global.ngrx.store = global.ngrx.store || {}, global.ngrx.store.testing = {}), global.ng.core, global.rxjs, global.ngrx.store, global.ng.core.testing));
}(this, (function (ɵngcc0,exports, core, rxjs, store, testing) { 'use strict';
...
MockStore.ɵfac = function MockStore_Factory(t) { return new (t || MockStore)(ɵngcc0.ɵɵinject(MockState), ɵngcc0.ɵɵinject(store.ActionsSubject), ɵngcc0.ɵɵinject(store.ReducerManager), ɵngcc0.ɵɵinject(store.INITIAL_STATE), ɵngcc0.ɵɵinject(MOCK_SELECTORS)); };
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(MockStore, [{
        type: core.Injectable
    }], function () { return [{ type: MockState }, { type: store.ActionsSubject }, { type: store.ReducerManager }, { type: undefined, decorators: [{
                type: core.Inject,
