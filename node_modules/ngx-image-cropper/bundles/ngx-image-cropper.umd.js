(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(require('@angular/core'),require('@angular/common'),exports, require('@angular/core'), require('@angular/common'), require('@angular/platform-browser')) :
    typeof define === 'function' && define.amd ? define('ngx-image-cropper', ['@angular/core','@angular/common','exports', '@angular/core', '@angular/common', '@angular/platform-browser'], factory) :
    (global = global || self, factory(global.ng.core,global.ng.common,global['ngx-image-cropper'] = {}, global.ng.core, global.ng.common, global.ng.platformBrowser));
}(this, function (ɵngcc0,ɵngcc1,exports, core, common, platformBrowser) { 
var _c0 = ["sourceImage"];
...
ImageCropperComponent.ɵfac = function ImageCropperComponent_Factory(t) { return new (t || ImageCropperComponent)(ɵngcc0.ɵɵdirectiveInject(platformBrowser.DomSanitizer), ɵngcc0.ɵɵdirectiveInject(core.ChangeDetectorRef)); };
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(ImageCropperComponent, [{
    ...
    }], function () { return [{ type: platformBrowser.DomSanitizer }, { type: core.ChangeDetectorRef }]; }, { format: [{
            type: core.Input
        }], maintainAspectRatio: [{
            type: core.Input
        }], transform: [{
